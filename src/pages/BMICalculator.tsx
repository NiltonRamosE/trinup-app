...
import { bmiCalculatorPage } from "@/lib/constants/seoPages"
...
export default function BMICalculatorPage() {
  ...
  return (
    <>
      <Helmet>
        {/* Primary Meta Tags */}
        <title>{bmiCalculatorPage.title}</title>
        <meta name="title" content={bmiCalculatorPage.title} />
        <meta name="description" content={bmiCalculatorPage.description} />
        <meta name="keywords" content={bmiCalculatorPage.keywords.join(", ")} />

        {/* Open Graph / Facebook */}
        <meta property="og:url" content={bmiCalculatorPage.url} />
        <meta property="og:title" content={bmiCalculatorPage.title} />
        <meta property="og:description" content={bmiCalculatorPage.description} />
        <meta property="og:image" content={bmiCalculatorPage.image} />

        {/* Twitter */}
        <meta name="twitter:url" content={bmiCalculatorPage.url} />
